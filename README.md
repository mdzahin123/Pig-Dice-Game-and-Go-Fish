...
3. Launch either game by opening the HTML file in a browser.
...
The submitted ZIP file includes:

* All **HTML files**
* All **JavaScript files**
* All **CSS files**
* Required **assets (images, cards, etc.)**

The games should run locally by simply opening the HTML files in a web browser.

---

# 👨‍💻 Author

Student submission for **CMPSC 421 – Spring 2025**
Homework 1 – JavaScript and DOM Manipulation
